...
export function PlayerProfile({ player, history, stats }: PlayerProfileProps) {
  ...
  function getMatchResult(match: MatchHistoryItem): { result: "win" | "loss"; score: string; team: string } {
    const isInFaction1 = match.teams.faction1.players.some((p) => p.player_id === player.player_id);
